...
| GUI uses the supplied assets and keeps rule enforcement in the engine | `src/blokus/gui.py`, `src/blokus/gui_assets.py`, `docs/gui_manual.md`, `tests/test_gui_support.py` |
