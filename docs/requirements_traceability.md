...
| Classic GUI with asset-backed presentation | `src/blokus/gui.py`, `src/blokus/gui_assets.py`, `src/blokus/gui_support.py` | `docs/gui_manual.md`, `tests/test_gui_support.py` |
